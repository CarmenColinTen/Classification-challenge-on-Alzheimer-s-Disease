...
test_pred <- predict(lda.model,, newdata =test_features, type = "raw")
test_prob <- predict(lda.model, newdata = test_features, type = "prob")
...
mypredictions <- read.csv('75741_MCICTLres.csv')
